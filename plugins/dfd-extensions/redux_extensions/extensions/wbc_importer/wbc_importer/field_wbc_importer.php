        ...
        public function render() {
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    if ( false == $imported ) {
                        echo '<div class="wbc-importer-buttons"><span class="spinner">'.esc_html__( 'Please Wait...', 'dfd-native' ).'</span><span class="button-primary importer-button import-demo-data">' . esc_html__( 'Import Demo', 'dfd-native' ) . '</span></div>';
                    }else {
