...
<div class="redux-sidebar">
    <ul class="redux-group-menu">
        ...
        <?php endif; ?>
		<li id="dfd_customization_services_section_group_li" class="redux-group-tab-link-li dark">
			<a href="javascript:void(0);" id="dfd_customization_services_section_group_li_a"
			   class="redux-group-tab-link-a custom-tab" data-rel="dfd_customization_services"><i>
				<img src="<?php echo DFD_EXTENSIONS_PLUGIN_URL.'redux_framework/ReduxCore/assets/img/spanner.png' ?>" width="15" alt="Icon" /></i><span
					class="group_title"><?php _e ( 'Customization and support', 'dfd-native' ); ?></span></a>
		</li>
    </ul>
</div>