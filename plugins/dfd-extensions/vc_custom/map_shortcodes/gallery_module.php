...
vc_map(
	array(
		...
		'params' => array(
			...
			array(
				'type' => 'number',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to define the width of the gallery thumbnail image','dfd-native').'</span></span>'.esc_html__('Image width', 'dfd-native'),
				'param_name' => 'image_width',
				'edit_field_class' => 'vc_column vc_col-sm-6 no-border-bottom crum_vc dfd-number-wrap',
				'dependency' => array('element' => 'gallery_style','value' => array('carousel','fitRows')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type' => 'number',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to define the height of the gallery thumbnail image','dfd-native').'</span></span>'.esc_html__('Image height', 'dfd-native'),
