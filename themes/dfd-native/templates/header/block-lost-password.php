...
<div id="dfd-lost-password">
	...
	<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
		<p>
			<label for="lost_user_login" class="dfd-widget-content-title"><?php esc_html_e('Username or Email', 'dfd-native') ?></label>
			<input type="text" name="user_login" id="lost_user_login" class="input" value="" />
		</p>
		<?php do_action( 'lostpassword_form' ); ?>
		<p class="submit">
			<input type="submit" name="wp-submit" id="wp-submit-lost" class="button button-primary button-large" value="<?php esc_attr_e('Get New Password', 'dfd-native'); ?>" />
