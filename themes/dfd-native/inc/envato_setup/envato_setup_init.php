				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => esc_html__( 'Upgrade', 'dfd-native' ),
							'description' => esc_html__( 'Upgrade Content and Settings', 'dfd-native' ),
							'pending' => esc_html__( 'Pending.', 'dfd-native' ),
							'installing' => esc_html__( 'Installing Updates.', 'dfd-native' ),
							'success' => esc_html__( 'Success.', 'dfd-native' ),
